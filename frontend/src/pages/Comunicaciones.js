  ...
  return (
    <div className="space-y-10 pb-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        ...
        <div className="bg-gray-800 rounded-2xl p-6 border border-gray-800/60 shadow-lg">
        ...
        <div className="xl:col-span-2 mt-4 bg-gray-800 rounded-2xl p-6 border border-gray-800/60 shadow-lg">
          <div className="flex items-start gap-4 mb-4">
