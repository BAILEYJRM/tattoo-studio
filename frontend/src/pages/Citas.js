  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white">{t('calendario_titulo')}</h1>
        <div className="flex items-center gap-2">
            {/* Sync Menu */}
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative">
          ...
          >
            {vista === 'calendario' ? t('mes') : vista === 'año' ? 'Año' : vista === 'semana' ? t('semana') : t('dia')}
            ...
            <>
              ...
              <div className="absolute left-0 mt-2 w-72 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-50 py-2 divide-y divide-gray-800">
                <div className="px-2 py-1">
                  {[['dia', t('dia'), 'D'], ['semana', t('semana'), 'S'], ['calendario', t('mes'), 'M'], ['año', 'Año', 'Y']].map(([v, label, key]) => (
