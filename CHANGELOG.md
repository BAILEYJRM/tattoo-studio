...
- **Propagación de Hover Completo en Botones y Enlaces**: Actualizados [`Layout.js`](file:///c:/Users/Bailey/proyectos/tattoo-studio/frontend/src/components/Layout.js) y [`AnimatedIcon`](file:///c:/Users/Bailey/proyectos/tattoo-studio/frontend/src/components/animate-ui/animated-icon.jsx) para que la animación del icono se dispare inmediatamente al pasar el ratón por **cualquier parte del área clicable del botón o enlace**, no únicamente sobre los 20px del icono.
